...
<head>
  ...
  <title>Cyberhawk - @yield('title')</title>
...
<body>
  <header class="bg-white">
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <div class="hidden lg:flex lg:flex-1 lg:justify-end">
        <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Sign out <span aria-hidden="true">&rarr;</span></a>
      </div>
    </nav>
      ...
      <div class="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 p-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
        ...
        <div class="mt-6 flow-root">
          <div class="-my-6 divide-y divide-gray-500/10">
            ...
            <div class="p-6">
              <a href="#" class="-mx-3 block rounded-lg px-3 p-2.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Sign out</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- Foooter -->
  <footer>
  <section class="bg-white border-[0] border-t border-solid border-black">
    <div class="max-w-screen-xl px-4 p-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
      ...
      <p class="mt-8 text-base leading-6 text-center text-gray-400">
        © 2023 Cyberhawk, Inc. All rights reserved.
      </p>
    </div>
  </section>
  </footer>
